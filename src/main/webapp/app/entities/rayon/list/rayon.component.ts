...
import { EntityArrayResponseType, RayonService } from '../service/rayon.service';
...
export class RayonComponent implements OnInit {
  ...
  trackId = (_index: number, item: IRayon): number => this.rayonService.getRayonIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.rayons = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IRayon[] | null): IRayon[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.rayonService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
